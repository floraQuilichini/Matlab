...
seg_dir = 'D:\autoencoder_data\depthmaps\training\segmentation_roipoly\';
...
for k = 1:size(new_seg_stacked, 3)
    ...
    im_bounds_closed = join_boundaries(im_bounds_bw, stacked_boundaries, additional_ending_leaves, max_dist);
